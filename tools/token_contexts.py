...
inside and its bare-word %, to classify it for the auto_tune blocking decision.
This is the "check the firings, don't eyeball it" step in the auto_tune curation
methodology (`rustbpe_variants/auto_tune/`), as a one-liner
...
Usage:
    ...
    uv run python -m tools.token_contexts \\
        --tokenizer ~/.cache/nanochat-variants/auto_tune/tokenizer ated
"""
